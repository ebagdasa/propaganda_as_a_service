...
from transformers import BartTokenizer, EvalPrediction, PreTrainedTokenizer, T5Tokenizer, TrainingArguments
...
class Seq2SeqDataCollator:
    def __init__(self, tokenizer, data_args, decoder_start_token_id, tpu_num_cores=None, training_args=None):
        self.tokenizer = tokenizer
